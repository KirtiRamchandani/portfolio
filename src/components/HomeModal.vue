<template>
  <div class="modal">
    <div class="modal-header">
      <span class="modal-icon close" @click="closeHomeModal()"></span>
    ...
    <div class="modal-body">
      ...
      <div class="social">
        <p>Find me on</p>
        <a
          href="https://www.linkedin.com/in/kirtikumar-anandrao-ramchandani-ba949b153/"
          target="_blank"
        ...
        >
        <a
          href="https://discordapp.com/users/397017832648605697"
          target="_blank"
        >
          <svg
            class="discord-icon"
